(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('class-validator'), require('class-transformer')) :
    typeof define === 'function' && define.amd ? define('@libertyware/ngx-form-core', ['exports', 'reflect-metadata', 'class-validator', 'class-transformer'], factory) :
    (global = global || self, factory((global.libertyware = global.libertyware || {}, global.libertyware['ngx-form-core'] = {}), null, global.classValidator, global.classTransformer));
}(this, (function (exports, reflectMetadata, classValidator, classTransformer) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function DateField() {
        return function (target, propertyKey) {
            return customFormField(exports.FieldType.DATE, target, propertyKey);
        };
    }
    ...
    function TextField() {
        return function (target, propertyKey) {
            return customFormField(exports.FieldType.TEXT, target, propertyKey);
        };
    }
    ...
    function Textareafield(options) {
        ...
        return function (target, propertyKey) {
            customFormField(exports.FieldType.TEXTAREA, target, propertyKey);
    ...
    function RadioField(options) {
        return function (target, propertyKey) {
            customFormField(exports.FieldType.RADIO, target, propertyKey);
    ...
    var FormGenModel = /** @class */ (function () {
        function FormGenModel(data) {
            classTransformer.plainToClassFromExist(this, data);
        }
        FormGenModel.prototype.isValid = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, classValidator.validate(this)];
                        case 1:
                            errors = _a.sent();
...
//# sourceMappingURL=libertyware-ngx-form-core.umd.js.map
